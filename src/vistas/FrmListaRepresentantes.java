 ...
 * @author PABLO
 */
public class FrmListaRepresentantes extends javax.swing.JDialog {
    ...
    public FrmListaRepresentantes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        try {
            cargarTablaRepresentantes(representanteDAO.listar());
        } catch (ErrorDB ex) {
    ...
    private void cargarTablaRepresentantes(List<RepresentanteDTO> lista) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado de representantes");
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        if (evt.getClickCount() > 1) {
            ...
            FrmAlumnos.txtIdrepresentante.setText(this.tabla.getValueAt(fila, 0).toString());
            FrmAlumnos.txtNomRepr.setText(this.tabla.getValueAt(fila, 1).toString());
            FrmAlumnos.txtApellRepr.setText(this.tabla.getValueAt(fila, 2).toString() + " " + this.tabla.getValueAt(fila, 3).toString());
            this.dispose();
        }
    ...
    private void txtBusquedaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBusquedaKeyReleased
        try {
            cargarTablaRepresentantes(representanteDAO.listar(this.cbBusqueda.getSelectedItem().toString(), this.txtBusqueda.getText()));
        } catch (ErrorDB ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmListaRepresentantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmListaRepresentantes dialog = new FrmListaRepresentantes(new javax.swing.JFrame(), true);
